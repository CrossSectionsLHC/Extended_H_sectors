...
print(scan_kap_hhH)
cx_kl_1_kt_1_full = [cross_sections_parts_original(GoM, MX, kt, ktH, k_hhh, kap_hhH/10, table)["full"] for kap_hhH in scan_kap_hhH]
cx_kl_1_kt_1_res = [cross_sections_parts_original(GoM, MX, kt, ktH, k_hhh, kap_hhH/10, table)["resonant_XS"] for kap_hhH in scan_kap_hhH]
cx_kl_1_kt_1_int = [abs(cross_sections_parts_original(GoM, MX, kt, ktH, k_hhh, kap_hhH/10, table)["res_nonres_int_XS"]) for kap_hhH in scan_kap_hhH]
...
plt.plot(scan_kap_hhH, cx_kl_1_kt_1_full, marker=".", label="BR(X -> HH)",linewidth=3.0) 
...
cx_kl_1_kt_1_full = [cross_sections_parts_original(GoMs, MX, kt, ktH, k_hhh, kap_hhH, table)["full"] for GoMs in GoM]
cx_kl_1_kt_1_res = [cross_sections_parts_original(GoMs, MX, kt, ktH, k_hhh, kap_hhH, table)["resonant_XS"] for GoMs in GoM]
cx_kl_1_kt_1_int = [cross_sections_parts_original(GoMs, MX, kt, ktH, k_hhh, kap_hhH, table)["res_nonres_int_XS"] for GoMs in GoM]
